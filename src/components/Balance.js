      ...
      <div className='component exchange__transfers'>
        ...
        <div className='exchange__transfers--form'>
          <div className='flex-between'>
            <p><small>Token<br /><img src={dapp} alt="Token Logo" /></small>{symbols && symbols[0]}</p>
        ...
        <div className='exchange__transfers--form'>
          <div className='flex-between'>
            <p><small>Token<br /><img src={eth} alt="Token Logo" /></small>{symbols && symbols[1]}</p>
            <p><small>Wallet</small><br />{tokenBalances && tokenBalances[1]}</p>
            <p><small>Exchange</small><br />{exchangeBalances && exchangeBalances[1]}</p>
  
          </div>
  
          <form onSubmit={isDeposit===true ? 
